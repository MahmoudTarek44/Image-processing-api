...
describe("Resizing image process test", function () {
    ...
    it("Check for existing image", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectAsync((0, imageProcessing_1.checkForExistingImage)(resultPath)).toBeResolved()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
